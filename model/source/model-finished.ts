...
import { type Model, type  Observation, model as predict, predictWithSoftmax, predictWithSoftmaxAndTemperature } from './model';
...
async function main() {
  ...
  const trainedModel: Model = {
    layers: [
      { neurons: [ { weights: [0.1, 0.2, 0.3, 0.4], bias: 0.1 }, { weights: [0.5, 0.6, 0.7, 0.8], bias: 0.2 }, { weights: [0.9, 0.1, 0.2, 0.3], bias: 0.3 }, { weights: [0.4, 0.5, 0.6, 0.7], bias: 0.4 } ] },
      { neurons: [ { weights: [0.1, 0.2, 0.3, 0.4], bias: 0.1 }, { weights: [0.5, 0.6, 0.7, 0.8], bias: 0.2 }, { weights: [0.9, 0.1, 0.2, 0.3], bias: 0.3 }, { weights: [0.4, 0.5, 0.6, 0.7], bias: 0.4 } ] },
      { neurons: [ { weights: [0.1, 0.2, 0.3, 0.4], bias: 0.1 }, { weights: [0.5, 0.6, 0.7, 0.8], bias: 0.2 }, { weights: [0.9, 0.1, 0.2, 0.3], bias: 0.3 }, { weights: [0.4, 0.5, 0.6, 0.7], bias: 0.4 } ] }
    ]
  };
